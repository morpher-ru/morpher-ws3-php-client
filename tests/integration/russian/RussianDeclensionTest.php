...
final class RussianDeclensionTest extends IntegrationBase
{
    public function testParse_Success(): void
    {
        ...
        $this->assertEquals("о тесте",
            $declensionResult->PrepositionalWithO);//не работает с токеном от бесплатной версии
        ...
        $this->assertEquals("о тестах",
            $declensionResult->Plural->PrepositionalWithO); //не работает с токеном от бесплатной версии
